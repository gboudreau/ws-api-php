...
class WealthsimpleAPI extends WealthsimpleAPIBase
{
    protected static function getGraphQLQuery(string $query_name): string {
        ...
        case 'FetchActivityFeedItems': return "query FetchActivityFeedItems(\$first: Int, \$cursor: Cursor, \$condition: ActivityCondition, \$orderBy: [ActivitiesOrderBy!] = OCCURRED_AT_DESC, \$accountScope: AccountScope = OWN) {\n  activityFeedItems(\n    first: \$first\n    after: \$cursor\n    condition: \$condition\n    orderBy: \$orderBy\n    accountScope: \$accountScope\n  ) {\n    edges {\n      node {\n        ...Activity\n        __typename\n      }\n      __typename\n    }\n    pageInfo {\n      hasNextPage\n      endCursor\n      __typename\n    }\n    __typename\n  }\n}\n\nfragment Activity on ActivityFeedItem {\n  accountId\n  aftOriginatorName\n  aftTransactionCategory\n  aftTransactionType\n  amount\n  amountSign\n  assetQuantity\n  assetSymbol\n  canonicalId\n  currency\n  eTransferEmail\n  eTransferName\n  externalCanonicalId\n  groupId\n  identityId\n  institutionName\n  occurredAt\n  p2pHandle\n  p2pMessage\n  spendMerchant\n  securityId\n  billPayCompanyName\n  billPayPayeeNickname\n  redactedExternalAccountNumber\n  opposingAccountId\n  status\n  subType\n  type\n  strikePrice\n  contractType\n  expiryDate\n  chequeNumber\n  provisionalCreditAmount\n  primaryBlocker\n  interestRate\n  frequency\n  counterAssetSymbol\n  rewardProgram\n  counterPartyCurrency\n  counterPartyCurrencyAmount\n  counterPartyName\n  fxRate\n  fees\n  reference\n  transferReason\n  transferType\n  optionStrategy\n  rejectionReason\n  resolvable\n  withholdingTaxAmount\n  announcementDate\n  recordDate\n  payableDate\n  grossDividendRate\n  unifiedStatus\n  estimatedCompletionDate\n  realizedPnl\n  settlementIndicator\n  __typename\n}";
        ...
        case 'FetchMonthlyStatementWithTransactions': return "query FetchMonthlyStatementWithTransactions(\$accountId: String!, \$period: String!, \$statementType: StatementType!) {\n  monthlyStatement(\n    accountId: \$accountId\n    period: \$period\n    statementType: \$statementType\n  ) {\n    ...MonthlyStatementWithTransactions\n    __typename\n  }\n}\n\nfragment MonthlyStatementWithTransactions on Statement {\n  id\n  statementType\n  data {\n    __typename\n    ... on CashMonthlyStatementObject {\n      custodianAccountId\n      currentTransactions {\n        transactionDate\n        transactionType\n        description\n        cashMovement\n        balance\n        __typename\n      }\n      __typename\n    }\n    ... on BrokerageMonthlyStatementObject {\n      custodianAccountId\n      isMultiCurrency\n      currentTransactions {\n        transactionDate\n        transactionType\n        description\n        cashMovement\n        balance\n        unit\n        __typename\n      }\n      activitiesPerCurrency {\n        currency\n        currentTransactions {\n          transactionDate\n          transactionType\n          description\n          cashMovement\n          balance\n          unit\n          __typename\n        }\n        __typename\n      }\n      __typename\n    }\n  }\n  __typename\n}";
    ...
    public function getStatementTransactions(string $account_id, string $period): array {
        ...
        if (is_object($statement)) {
            $data = isset($statement->data) ? $statement->data : new stdClass();
            $transactions = isset($data->currentTransactions) ? $data->currentTransactions : [];
        }
        if (empty($transactions)) {
            return [];
        }
        if (!is_array($transactions)) {
            throw new WSApiException("Unexpected response format to GraphQL query 'FetchMonthlyStatementWithTransactions'", 0, $statement);
        }
        return $transactions;
    }
